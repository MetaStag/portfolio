  ...
  return (
    <div>
      ...
      <div className={`app ${toggle} min-h-screen p-4`}>
        {/* Navbar */}
        <div
          className={`div ${toggle} py-6 px-4 rounded-xl flex justify-between items-center`}
        >
          <span className="font-bold flex-1">MetaStag</span>
          <div className="flex items-center gap-x-12">
            <div className="flex flex-row items-center gap-x-4">
              <span>Click on the toggle!</span>
              <div
            ...
            <a
              href="https://www.linkedin.com/in/abhibhav-sharma/"
              target="_blank"
              rel="noreferrer"
            >
              Contact
        ...
        {/* Main Bento Grid */}
        <motion.div
          className="mx-12 my-12 grid grid-cols-1 lg:grid-cols-3 gap-4"
          initial={{ opacity: 0, y: 100 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 1, delay: 0.5, ease: "linear" }}
        >
          <motion.div
            className={`div ${toggle} rounded-lg p-5 flex flex-col lg:col-span-2`}
          ...
          <motion.div
            className={`div ${toggle} rounded-lg p-5 flex flex-col row-span-2`}
            whileHover={{ scale: 1.1 }}
          >
            <div
            ...
            {projects &&
              projects.map((item) => (
                <>
                  <a
                    className="underline decoration-indigo-400 hover:text-lg hover:text-indigo-700 mt-5"
                    target="_blank"
                    rel="noreferrer"
                    href={item.link}
                  >
          ...
          <motion.div
            className={`div ${toggle} rounded-lg p-5 flex flex-col`}
            whileHover={{ scale: 1.1 }}
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 mt-5 p-2">
              <span>
                <img
                  src={ReactIcon}
                  className="inline w-8 px-1 py-2"
                  alt="React icon"
                ></img>
                MERN stack
              </span>
          ...
          <motion.div
            className="bg-[#00B4D8] rounded-lg py-5 flex flex-col"
            whileHover={{ scale: 1.1 }}
          >
            <img
              src={data.avatar_url}
          ...
          <motion.div
            className={`div ${toggle} rounded-lg p-5 flex flex-row justify-center`}
            whileHover={{ scale: 1.1 }}
          >
          ...
          <motion.div
            ...
            whileHover={{ scale: 1.1 }}
          >
            <span className="text-[#0077B6] text-lg font-bold mb-3">
              Future Goals
            </span>
            {future.map((item) => (
              <span>- {item}</span>
